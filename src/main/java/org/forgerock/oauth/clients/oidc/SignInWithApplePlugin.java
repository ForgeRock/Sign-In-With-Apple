 ...
 * @since AM 5.5.0
 */
public class SignInWithApplePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(SignInWithApplePlugin.currentVersion, 
				Collections.singletonList(SignInWithApple.class));
	}
	...
	public String getPluginVersion() {
		return SignInWithApplePlugin.currentVersion;
	}
}
